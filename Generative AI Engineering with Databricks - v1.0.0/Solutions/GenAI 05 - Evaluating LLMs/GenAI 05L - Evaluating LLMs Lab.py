...
# ANSWER
translator_pipeline = pipeline("translation_en_to_fr", model="t5-small", tokenizer="t5-small")
t5_translated_text = translator_pipeline(sample["highlights"])
...
# ANSWER
translator_pipeline_hnlp = pipeline(
    task="translation",
    model="Helsinki-NLP/opus-mt-en-fr",
    model_kwargs={"cache_dir": DA.paths.datasets}
)
hnlp_translated_text = translator_pipeline_hnlp(sample["highlights"])
