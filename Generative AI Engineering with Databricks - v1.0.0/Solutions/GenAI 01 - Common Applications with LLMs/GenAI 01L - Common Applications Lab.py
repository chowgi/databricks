...
# MAGIC %md
# MAGIC # Common Applications with LLMs - Lab 
# MAGIC
...
# MAGIC %md 
# MAGIC ### Find good models for your tasks
# MAGIC
...
# MAGIC %md 
# MAGIC ### Task 3: Few-shot learning
# MAGIC
...
prompt = """For each food, suggest a good drink pairing:
...
# MAGIC %md 
# MAGIC ## Explore Model and Tokenizer Settings
# MAGIC
# MAGIC So far, we have used pipelines in a very basic way, without worrying about configuration options.  In this section, you will explore the various options for models and tokenizers to learn how they affect LLM behaviour.
# MAGIC
...
# MAGIC ## Summary
# MAGIC
# MAGIC In this lab we have practiced some common LLM applications using Hugging Face. First, we showed how to find good models for your tasks. Then, we built three common LLM tasks; summarization, translation and few-shot learning. In the final part, we explored model and tokinzer settings by changing pipeline parameters.
